...
namespace Kodosi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260712075155_AddStagedRoomInvitationAuthorization")]
    partial class AddStagedRoomInvitationAuthorization
    {
            ...
            modelBuilder.Entity("Kodosi.Domain.RoomInvitation", b =>
                {
                    ...
                    b.ToTable("room_invitations", null, t =>
                        {
                            t.HasCheckConstraint("CK_room_invitations_status_allowed_values", "\"status\" IN ('Pending', 'Accepted', 'Declined', 'Cancelled')");
                        });
                });
