...
namespace Kodosi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260820153800_AddAccessOverrideExpiryEnforcement")]
    partial class AddAccessOverrideExpiryEnforcement
    {
            ...
            modelBuilder.Entity("Kodosi.Domain.AccessOverrideAuditEntry", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ExpectedExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("expected_expires_at");

                    b.Property<DateTimeOffset?>("ExpectedRevokedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("expected_revoked_at");
                    ...
                    b.ToTable("access_override_audit", null, t =>
                        {
                            t.HasCheckConstraint("CK_access_override_audit_pending_expiry_evidence", "realtime_enforced_at IS NOT NULL OR (action = 'Revoked' AND reason = 'Expired' AND session_incarnation_id IS NOT NULL AND session_started_at IS NOT NULL AND expected_expires_at IS NOT NULL AND expected_revoked_at IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Kodosi.Domain.UserDevice", b =>
                {
                    ...
                    b.ToTable("user_devices", null, t =>
                        {
                            t.HasCheckConstraint("CK_user_devices_certificate_bounded", "octet_length(\"device_certificate\") BETWEEN 1 AND 5772");

                            t.HasCheckConstraint("CK_user_devices_certificate_signature_exact", "octet_length(\"device_certificate_signature\") = 3309");
                        });
                });
            ...
            modelBuilder.Entity("Kodosi.Domain.UserDeviceList", b =>
                {
                    ...
                    b.ToTable("user_device_lists", null, t =>
                        {
                            t.HasCheckConstraint("CK_user_device_lists_body_bounded", "octet_length(\"body\") <= 527432");
                            ...
                            t.HasCheckConstraint("CK_user_device_lists_signature_exact", "octet_length(\"signature\") = 3309");
                        });
                });
