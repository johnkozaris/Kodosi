...
namespace Kodosi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260417193927_AddCurrentKeyGeneration")]
    partial class AddCurrentKeyGeneration
    {
            ...
            modelBuilder.Entity("Kodosi.Domain.SessionKeyBlob", b =>
                {
                    ...
                    b.Property<byte[]>("AadContext")
                        .HasColumnType("bytea")
                        .HasColumnName("aad_context");
                    ...
                    b.ToTable("session_key_blobs", null, t =>
                        {
                            t.HasCheckConstraint("CK_session_key_blobs_issued_at_ms_positive", "\"issued_at_ms\" IS NULL OR \"issued_at_ms\" > 0");
                        });
                });
