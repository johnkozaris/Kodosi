...
namespace Kodosi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260525082803_RenameWorkspacesToRooms")]
    partial class RenameWorkspacesToRooms
    {
            ...
            modelBuilder.Entity("Kodosi.Domain.Session", b =>
                {
                    ...
                    b.ToTable("sessions", null, t =>
                        {
                            t.HasCheckConstraint("CK_sessions_room_scope_matches_room_id", "(\"scope\" = 'Workspace' AND \"workspace_id\" IS NOT NULL)\nOR (\"scope\" <> 'Workspace' AND \"workspace_id\" IS NULL)");
