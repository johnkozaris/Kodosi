...
namespace Kodosi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260906164733_AddRoomTaskSnapshotRevision")]
    partial class AddRoomTaskSnapshotRevision
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kodosi.Domain.ArtifactEndorsement", b =>
                {
                    ...
                    b.Property<string>("EndorserDeviceId")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("endorser_device_id");
                    ...
                    b.HasKey("UserId", "IdentityIncarnationId", "ArtifactDigest");

                    b.ToTable("artifact_endorsements", null, t =>
                        {
                            t.HasCheckConstraint("CK_artifact_endorsements_digest", "artifact_digest ~ '^[0-9a-f]{64}$'");

                            t.HasCheckConstraint("CK_artifact_endorsements_signature", "octet_length(signature) = 3309");
                        });
                });
            ...
            modelBuilder.Entity("Kodosi.Domain.Room", b =>
                {
                    ...
                    b.Property<long>("TaskRevision")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L)
                        .HasColumnName("task_revision");
                    ...
                    b.ToTable("rooms", null, t =>
                        {
                            t.HasCheckConstraint("CK_rooms_task_revision_nonnegative", "task_revision >= 0");
                        });
                });
