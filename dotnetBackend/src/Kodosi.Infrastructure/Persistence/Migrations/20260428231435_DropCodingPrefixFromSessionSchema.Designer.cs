...
namespace Kodosi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260428231435_DropCodingPrefixFromSessionSchema")]
    partial class DropCodingPrefixFromSessionSchema
    {
            ...
            modelBuilder.Entity("Kodosi.Domain.Session", b =>
                {
                    ...
                    b.ToTable("sessions", null, t =>
                        {
                            t.HasCheckConstraint("CK_sessions_public_scope_is_view_only", "\"scope\" <> 'Public' OR \"default_access\" = 'View'");
