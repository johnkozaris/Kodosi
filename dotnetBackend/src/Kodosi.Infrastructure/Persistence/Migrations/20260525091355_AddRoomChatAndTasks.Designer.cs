...
namespace Kodosi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260525091355_AddRoomChatAndTasks")]
    partial class AddRoomChatAndTasks
    {
            ...
            modelBuilder.Entity("Kodosi.Domain.RoomInvitation", b =>
                {
                    ...
                    b.ToTable("room_invitations", null, t =>
                        {
                            t.HasCheckConstraint("CK_room_invitations_status_allowed_values", "\"status\" IN ('Pending', 'Accepted', 'Declined')");
                        });
                });
            ...
            modelBuilder.Entity("Kodosi.Domain.Session", b =>
                {
                    ...
                    b.ToTable("sessions", null, t =>
                        {
                            t.HasCheckConstraint("CK_sessions_room_scope_matches_room_id", "(\"scope\" = 'Room' AND \"workspace_id\" IS NOT NULL)\nOR (\"scope\" <> 'Room' AND \"workspace_id\" IS NULL)");

                            t.HasCheckConstraint("CK_sessions_scope_allowed_values", "\"scope\" IN ('Private', 'Friends', 'Room')");
                        });
                });
