...
#pragma warning restore SYSLIB0050
    ...
    public static void SetDeviceCertificate(UserDevice device, byte[] certificate) =>
        Set(device, nameof(UserDevice.DeviceCertificate), certificate);

    public static void SetDeviceCertificateSignature(UserDevice device, byte[] signature) =>
        Set(device, nameof(UserDevice.DeviceCertificateSignature), signature);

    public static void SetDeviceListBody(UserDeviceList list, byte[] body) =>
        Set(list, nameof(UserDeviceList.Body), body);
